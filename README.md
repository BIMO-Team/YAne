...
To download the pacakge, use the following link: https://anonymous.4open.science/api/repo/YAne-1406/zip or click the icon "zip" on the top right of this page.
...
*Note: Confidence = 0 and 1 are required to be included in the customized variations, arranged as the first and the last order.*
...
* Classifiers built from the primer-extracted datasets are saved in the directory `primer_eval/classifier`. These can be used during taxonomic assignment steps based on QIIME2.
