...
* You can preliminarily explore the potential mock community records from [NCBI GenBank database](https://www.ncbi.nlm.nih.gov/genbank/). Number of records will be shown, filtering options can be adjusted, and the Entrez string will be automatically generated by the webpage located in the box at the right side of the page (*Search details*). 
