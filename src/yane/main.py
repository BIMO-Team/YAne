...
#=======================================================================================================================
    ...
    for line in f:
        ...
        for line in f_tax:
            ...
            inf_taxa_dict["Genus"] = Genus
            #print(Genus)
            Species = line.split("\t")[1].strip().split(";")[5].split("__")[1]+" "+line.split("\t")[1].strip().split(";")[6].split("__")[1]
            inf_taxa_dict["Species"] = Species #inf_taxa_dict = {kingdom:Metazoa, phylum: ..., class:... ,.., .species:...}
            #print(Species)
...
def main():
    ...
    parser_ep.add_argument("--p-target-name", type=str, required=True, help="Target taxa name [required]")
    ## Optional arguments
